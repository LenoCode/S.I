...
public class ServerSocketCreator {
    ...
    public static ServerCreatedSocket createServer(
            String hostAddress,
            Class<? extends NotificationerActions> classNotificationer,
            DataTradeModel[] dataTrades,
            int port,
            int backlog,
            int timeout
    ){
        return new ServerCreatedSocket() {
            ...
            public void initSocket() throws IOException, SocketExceptions {
                ...
                ServerNotificationerInitializator serverNotificationerInitializator = new ServerNotificationerInitializator(classNotificationer,dataTrades);
                ...
                basicSocket.setServerNotificationerInitializator(serverNotificationerInitializator);
